...
if __name__ == "__main__":
    ...
    # resume_training("checkpoints/speaker_enhancer_epoch_050.pt", 
...
# def train_model(clean_dir, noise_dir, other_speaker_dir):
#     # Initialize model
#     device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
#     print(f"Using device: {device}")
...
#             checkpoint_path = f"speaker_enhancer_epoch_{epoch+1}.pt"
#             torch.save({
#                 'epoch': epoch + 1,
#                 'model_state_dict': model.state_dict(),
#                 'optimizer_state_dict': optimizer.state_dict(),
...
# if __name__ == "__main__":
#     # Replace these paths with your actual directory paths
#     clean_audio_dir = "data/clean_audio"
#     noise_dir = "data/noise_audio"
#     other_speaker_dir = "data/noise_audio"
...
# #         # Save model checkpoint
# #         if (epoch + 1) % 10 == 0:
# #             torch.save(model.state_dict(), f"speaker_enhancer_epoch_{epoch+1}.pt")
